...
public class ManagedListItemServiceTest extends BaseServiceTest<ManagedListItem> {
    ...
    public static void main(String[] args) {
        ...
        //test.runBaseTests();
        test.runManagedListItemTests();
    }

    public void runManagedListItemTests() {
        ArrayList<ManagedListItem> shipTypes = getService().getByListAndProjectFk(ManagedList.SHIP_TYPES, null);
        System.out.println("ManagedList.SHIP_TYPES=" + ManagedList.SHIP_TYPES);
        System.out.println("ManagedList.SHIP_TYPES.isGlobal()=" + ManagedList.SHIP_TYPES.isGlobal());
        System.out.println("shipTypes=" + shipTypes);
    }
