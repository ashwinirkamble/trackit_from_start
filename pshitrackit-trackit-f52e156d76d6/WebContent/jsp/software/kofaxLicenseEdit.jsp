...
<bean:define id="defaultPageTitle" value="Kofax License Add/Edit"/>
...
<div class="colmask leftmenu"><div class="colright">
    ...
    <tags:projectPkBreadcrumb projectPk="${projectPk}" pageTitle="${pageTitle}" hideOptions="true"
      parentUrl="software.do?action=kofaxLicenseList&projectPk=${projectPk}" parentTitle="Kofax License List" />
		...
		<% if (editType.equals("add")) { %>
			<input type="hidden" name="action" value="kofaxLicenseAddDo"/>
		<% } else { %>
			<input type="hidden" name="action" value="kofaxLicenseEditDo"/>
			<html:hidden name="inputBean" property="kofaxLicensePk"/>
		<% } %>
		<tbody>
			<tr><th>Kofax License</th></tr>
			<tr><td class="nobordered" align="left"> <!-- tan_table -->
				...
				<tbody>
					<tr>
						<td rowspan="3" class="TOP"><img src="images/logo_kofax.png"/></td>
						<td></td>
						<td></td>
						<td colspan="2" align="right">
							<label styleClass="checkbox-inline">
								<html:checkbox name="inputBean" property="internalUseInd" value="Y"/>
								Internal Use Only
							</label>
						</td>
					</tr>
		...
		<table id="borderlessTable" border="0" cellspacing="0"><tbody>
			<tr>
				...
				<td align="center">
					<a class="btn btn-default" href="software.do?action=kofaxLicenseList&projectPk=<bean:write name="projectPk"/>">Cancel</a>
				</td>
			</tr>
		</tbody></table>
...
<script type="text/javascript">
	...
	function valFields() {
		...
		if (licenseExpiryDate.length >= 1 && !validateDate(licenseExpiryDate, "License Expiration Date")) {
