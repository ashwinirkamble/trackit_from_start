...
<bean:define id="defaultPageTitle" value="VRS License List"/>
...
<div class="colmask leftmenu"><div class="colright">
    ...
    <tags:projectPkBreadcrumb projectPk="${projectPk}" pageTitle="${pageTitle}" hideOptions="true" />
		...
		<a href="software.do?action=vrsLicenseAdd&projectPk=<bean:write name="projectPk"/>" class="btn btn-success"><span class="glyphicon glyphicon-plus"></span> Add New License</a>
		...
		<% } else { %>
			<a href="export.do?action=vrsLicenseXlsx&projectPk=<bean:write name="projectPk"/>" class="btn btn-default"><img src="images/file_icons/sml_file_xls.gif"/> Export to Excel</a>

			<p align="center">
			<center>
			<table id="vrsLicenseTable" class="display" cellspacing="0">
			<thead>
				<tr>
			...
			<logic:iterate id="resultBean" name="resultList" type="com.premiersolutionshi.old.bean.SoftwareBean">
				<tr align="left">
					...
					<td align="center">
						<a href="software.do?action=vrsLicenseEdit&vrsLicensePk=<bean:write name="resultBean" property="vrsLicensePk"/>&projectPk=<bean:write name="projectPk"/>"><img src="images/icon_edit.png" title="Edit"/></a>
						&nbsp;<a href="software.do?action=vrsLicenseDeleteDo&vrsLicensePk=<bean:write name="resultBean" property="vrsLicensePk"/>&projectPk=<bean:write name="projectPk"/>" onclick="return confirmDelete('<bean:write name="resultBean" property="licenseKey"/>');"><img src="images/icon_delete.png" title="Delete"/></a>
					</td>
				</tr>
			</logic:iterate>
			</tbody>
...
<script type="text/javascript">
	$(document).ready(function () {
		var table = $('#vrsLicenseTable').DataTable( {
			"order": [[ 1, "asc" ]],
