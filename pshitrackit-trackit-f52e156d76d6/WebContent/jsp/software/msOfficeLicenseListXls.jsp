...
<bean:define id="defaultPageTitle" value="MS Office Licenses"/>
...
<%
	...
	response.setHeader("Content-Disposition", "attachment;filename=msoffice_license.xls");
%>
...
<table id="xlsTable" border="0" cellspacing="3" cellpadding="3">
	...
	<logic:iterate id="resultBean" name="resultList" type="com.premiersolutionshi.old.bean.SoftwareBean">
		<tr>
			...
			<td class="txtRow"><bean:write name="resultBean" property="installedCnt"/></td>
