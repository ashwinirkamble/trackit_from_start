...
<bean:define id="defaultPageTitle" value="Misc Software"/>
...
<%
	...
	response.setHeader("Content-Disposition", "attachment;filename=misc_software.xls");
%>
...
<table id="xlsTable" border="0" cellspacing="3" cellpadding="3">
	...
	<logic:iterate id="resultBean" name="resultList" type="com.premiersolutionshi.old.bean.SoftwareBean">
		<tr>
			...
			<td class="txtRow"><bean:write name="resultBean" property="productKey"/></td>
			...
			<td style="<bean:write name="resultBean" property="licenseExpiryDateCss"/>" align="center"><bean:write name="resultBean" property="licenseExpiryDate"/></td>
