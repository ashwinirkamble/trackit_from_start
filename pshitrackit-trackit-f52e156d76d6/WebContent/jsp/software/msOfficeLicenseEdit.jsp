...
<bean:define id="defaultPageTitle" value="MS Office License Add/Edit"/>
...
<div class="colmask leftmenu"><div class="colright">
    ...
    <tags:projectPkBreadcrumb projectPk="${projectPk}" pageTitle="${pageTitle}" hideOptions="true"
      parentUrl="software.do?action=msOfficeLicenseList&projectPk=${projectPk}" parentTitle="MS Office License List" />
		...
		<% if (editType.equals("add")) { %>
			<input type="hidden" name="action" value="msOfficeLicenseAddDo"/>
		<% } else { %>
			<input type="hidden" name="action" value="msOfficeLicenseEditDo"/>
			<html:hidden name="inputBean" property="msOfficeLicensePk"/>
		<% } %>
		<tbody>
			<tr><th>Microsoft Office License</th></tr>
			<tr><td class="nobordered" align="left"> <!-- tan_table -->
				...
				<colgroup><col width="100"/><col width="125"/></colgroup>
					<tr>
						<td rowspan="3" class="TOP"><img src="images/logo_msoffice.png" width="180" height="75"/></td>
					...
					<tr>
						<td class="fieldName"><span class="regAsterisk">*</span> License:</td>
						<td><html:text name="inputBean" property="licenseKey" size="34" maxlength="29"/></td>
					</tr>
					<tr>
		...
		<table id="borderlessTable" border="0" cellspacing="0"><tbody>
			<tr>
				...
				<td align="center">
					<a class="btn btn-default" href="software.do?action=msOfficeLicenseList&projectPk=<bean:write name="projectPk"/>">Cancel</a>
				</td>
			</tr>
		</tbody></table>
		</html:form>
