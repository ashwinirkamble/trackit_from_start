...
<bean:define id="defaultPageTitle" value="Laptops"/>
...
<%
	...
	response.setHeader("Content-Disposition", "attachment;filename=laptops.xls");
%>
...
<table id="xlsTable" border="0" cellspacing="3" cellpadding="3">
	...
	<logic:iterate id="resultBean" name="resultList" type="com.premiersolutionshi.old.bean.HardwareBean">
		<tr>
			...
			<td class="txtRow"><bean:write name="resultBean" property="macAddress"/></td>
			<td class="txtRow"><bean:write name="resultBean" property="origin"/></td>
			<td><bean:write name="resultBean" property="receivedDate"/></td>
			<td><bean:write name="resultBean" property="preppedDate"/></td>
			<td>
