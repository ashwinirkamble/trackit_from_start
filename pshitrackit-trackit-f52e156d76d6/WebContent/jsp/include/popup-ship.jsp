        ...
        <tr><td class="nobordered">
          ...
          <tbody>
            <tr>
              ...
              <td class="fieldValue">${shipBean.shipName}</td>
            </tr>
            <tr>
              <td class="fieldName">Type/Hull:</td>
              <td class="fieldValue">${shipBean.type}&nbsp;${shipBean.hull}</td>
            </tr>
            <tr>
              <td class="fieldName">UIC:</td>
              <td class="fieldValue">${shipBean.uic}</td>
            </tr>
            <tr>
              <td class="fieldName">Homeport:</td>
              <td class="fieldValue">${shipBean.homeport}</td>
            </tr>
            <tr>
              <td class="fieldName">TYCOM:</td>
              <td class="fieldValue">${shipBean.tycomDisplay}</td>
            </tr>
            <tr>
              <td class="fieldName">RSupply Version:</td>
              <td class="fieldValue">${shipBean.rsupply}</td>
            </tr>
            ...
            <logic:notEmpty name="shipBean" property="shipPk">
              <tr>
                <td colspan="2">&nbsp;</td>
              </tr>
              <tr>
                <td class="fieldName">LOGCOP:</td>
                <td><a href="report.do?action=transmittalDetail&shipPk=${shipBean.shipPk}&projectPk=${projectPk}">View Transmittal Details</a></td>
              </tr>
            </logic:notEmpty>
          </tbody>
          </table>
            ...
            <tr>
              ...
              <td>
                <logic:notEmpty name="configuredSystemBean" property="dmsVersion">
                  ${configuredSystemBean.dmsVersion} (current: ${currDmsVersion})
      ...
      <thead>
        <tr>
          <th>
            POCs
            <logic:present name="shipBean">
              <a href="user.do?action=pocList&shipPk=${shipBean.shipPk}&projectPk=${projectPk}">
                <img src="images/icon_edit.png" height="12" title="Edit"/>
              </a>
            </logic:present>
          </th>
      ...
      <thead>
        <tr>
          <th>
            Open Issues
            <logic:present name="shipBean">
              <a href="support.do?action=issueList&uic=${shipBean.uic}&projectPk=${projectPk}"><img src="images/icon_view.png" height="12" title="View"/></a>
              <a href="issue.do?action=add&shipPk=${shipBean.shipPk}&projectPk=${projectPk}"><img src="images/icon_plus.gif" title="Add"/></a>
            </logic:present>
          </th>
        </tr>
      </thead>
