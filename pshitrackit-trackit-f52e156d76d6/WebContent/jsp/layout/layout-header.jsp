...
<head>
  ...
  <title>Premier Solutions HI</title>
  ...
  <div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" href="/menu.do">Premier Solutions HI</a>
      </div>
      <!-- /.navbar-header -->
      <ul class="nav navbar-top-links navbar-right">
        ...
        <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#"> <i class="fa fa-user fa-fw"></i> <i
          ...
          <ul class="dropdown-menu dropdown-user">
            ...
            <li><a href="/login.do?action=changePassword"><i class="fa fa-gear fa-fw"></i> Change Password</a></li>
      ...
      <div class="navbar-default sidebar" role="navigation">
        <div class="sidebar-nav navbar-collapse">
          <ul class="nav" id="side-menu">
            ...
            -->
            <li><a href="/menu.do"><i class="fa fa-dashboard fa-fw"></i> Dashboard</a></li>

            <li><a href="/support.do?action=issueList&projectPk=1"><i class="fa fa-tasks fa-fw"></i> FACET Issues</a></li>

            <li><a href="#"><i class="fa fa-wrench fa-fw"></i> Hardware/Software<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level">
                <li><a href="/hardware.do?action=laptopList&projectPk=1">Laptops</a></li>
                <li><a href="/hardware.do?action=scannerList&projectPk=1">Scanners</a></li>
                <li><a href="/hardware.do?action=miscList&projectPk=1">Misc Hardware</a></li>
                <li><a href="/software.do?action=kofaxLicenseList&projectPk=1">Kofax Licenses</a></li>
                <li><a href="/software.do?action=bulkKofaxLicenseEdit&projectPk=1">Bulk Kofax License Expiration</a></li>
                <li><a href="/software.do?action=vrsLicenseList&projectPk=1">VRS Licenses</a></li>
                <li><a href="/software.do?action=msOfficeLicenseList&projectPk=1">MS Office Licenses</a></li>
                <li><a href="/software.do?action=miscLicenseList&projectPk=1">Misc Software</a></li>
              </ul> <!-- /.nav-second-level -->
            </li>

            <li><a href="#"><i class="fa fa-wrench fa-fw"></i> Administration<span class="fa arrow"></span></a>
              <ul class="nav nav-second-level">
                <li><a href="/project.do?action=projectList">Manage Projects</a></li>
                <li><a href="/user.do?action=userList">Manage Users</a></li>
                <li><a href="/ship.do?action=shipList">Manage UIC List</a></li>
              </ul> <!-- /.nav-second-level -->
            </li>
